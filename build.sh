...
xcodebuild -workspace Box2D.xcworkspace -scheme Testbed -configuration Release -verbose #OTHER_CFLAGS="-Rpass=loop-vectorize -Rpass-missed=loop-vectorize -Rpass-analysis=loop-vectorize"
