							...
							const b2CircleShape* circleB, const b2Transform& xfB)
{
	...
	b2Vec2 n(-e.vector[1], e.vector[0]);
	if (b2Dot(n, Q - A) < 0.0f)
	{
		n.Set(-n.vector[0], -n.vector[1]);
	}
	n.Normalize();
						   ...
						   const b2PolygonShape* polygonB, const b2Transform& xfB)
{
	...
	edge1.Normalize();
	m_normal1.Set(edge1.vector[1], -edge1.vector[0]);
	...
	if (hasVertex0)
	{
		...
		edge0.Normalize();
		m_normal0.Set(edge0.vector[1], -edge0.vector[0]);
	...
	if (hasVertex3)
	{
		...
		edge2.Normalize();
		m_normal2.Set(edge2.vector[1], -edge2.vector[0]);
	...
	rf.sideNormal1.Set(rf.normal.vector[1], -rf.normal.vector[0]);
...
b2EPAxis b2EPCollider::ComputePolygonSeparation()
{
	...
	b2Vec2 perp(-m_normal.vector[1], m_normal.vector[0]);
